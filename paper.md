...
&emsp;&emsp;围绕这研究的主题，文本简要列举了开发网站的相关技术如Django框架，ORM对象关系映射，Django-templates模板引擎，SQlite数据库管理系统和支持websocket的Django-channels插件。接着对网站进行需求分析和总体设计，在完成需求分析的基础上对网站进行总体设计和详细设计
